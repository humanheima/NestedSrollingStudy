...
import kotlinx.android.synthetic.main.activity_nested_scroll_rv_two.*
import java.util.*
 ...
 *
 */
class NestedScrollRVTwoActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun launch(context: Context) {
            val intent = Intent(context, NestedScrollRVTwoActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nested_scroll_rv_two)
        initDatas()
    }
